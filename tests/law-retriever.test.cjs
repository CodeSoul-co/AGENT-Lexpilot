...
test('loads forty-six integrity-pinned official articles across every supported legal domain', () => {
...
test('pins the verified law name, article number, and effective date for each sample', () => {
  ...
  assert.deepEqual(summary, {
    ...
    'cn.labor-contract-law.article-48': [
      '中华人民共和国劳动合同法',
      '第四十八条',
      '2013-07-01'
    ],
    'cn.civil-code.article-1064': ['中华人民共和国民法典', '第一千零六十四条', '2021-01-01'],
    'cn.civil-code.article-670': ['中华人民共和国民法典', '第六百七十条', '2021-01-01'],
    ...
    'cn.labor-contract-law.article-50': [
      '中华人民共和国劳动合同法',
      '第五十条',
      '2013-07-01'
    ],
    'cn.civil-code.article-1066': ['中华人民共和国民法典', '第一千零六十六条', '2021-01-01'],
    'cn.civil-code.article-669': ['中华人民共和国民法典', '第六百六十九条', '2021-01-01'],
    'cn.tax-collection-administration-law.article-66': [
      '中华人民共和国税收征收管理法',
      '第六十六条',
      '2015-04-24'
    ],
    'cn.patent-law.article-67': ['中华人民共和国专利法', '第六十七条', '2021-06-01'],
    'cn.labor-contract-law.article-38': [
      '中华人民共和国劳动合同法',
      '第三十八条',
      '2013-07-01'
    ],
    'cn.civil-code.article-1076': ['中华人民共和国民法典', '第一千零七十六条', '2021-01-01'],
    'cn.civil-code.article-671': ['中华人民共和国民法典', '第六百七十一条', '2021-01-01'],
    'cn.tax-collection-administration-law.article-67': [
      '中华人民共和国税收征收管理法',
      '第六十七条',
      '2015-04-24'
    ],
    'cn.patent-law.article-66': ['中华人民共和国专利法', '第六十六条', '2021-06-01'],
    'cn.labor-contract-law.article-37': [
      '中华人民共和国劳动合同法',
      '第三十七条',
      '2013-07-01'
    ],
    'cn.civil-code.article-1077': ['中华人民共和国民法典', '第一千零七十七条', '2021-01-01'],
    'cn.civil-code.article-672': ['中华人民共和国民法典', '第六百七十二条', '2021-01-01'],
    'cn.tax-collection-administration-law.article-68': [
      '中华人民共和国税收征收管理法',
      '第六十八条',
      '2015-04-24'
    ],
    'cn.patent-law.article-65': ['中华人民共和国专利法', '第六十五条', '2021-06-01']
  });
});
...
test('keeps staged corpus batches out of retrieval until dedicated regressions enable them', () => {
  ...
  const stagedIds = [
    ...
    'cn.labor-contract-law.article-50',
    'cn.civil-code.article-1066',
    'cn.civil-code.article-669',
    'cn.tax-collection-administration-law.article-66',
    'cn.patent-law.article-67',
    'cn.labor-contract-law.article-38',
    'cn.civil-code.article-1076',
    'cn.civil-code.article-671',
    'cn.tax-collection-administration-law.article-67',
    'cn.patent-law.article-66',
    'cn.labor-contract-law.article-37',
    'cn.civil-code.article-1077',
    'cn.civil-code.article-672',
    'cn.tax-collection-administration-law.article-68',
    'cn.patent-law.article-65'
  ];
